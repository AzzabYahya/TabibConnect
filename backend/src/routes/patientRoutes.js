...
router.get('/me/profile', authenticate, authorize(['PATIENT']), asyncHandler(patientController.getPatientProfile));
router.put('/me/profile', authenticate, authorize(['PATIENT']), asyncHandler(patientController.updatePatientProfile));
